        ...
        <div>
            <section className="bg-accent">
                <div className="max-w-[1200px] mx-auto text-center py-28">
                    <div className="max-w-[800px] mx-auto">
                        ...
                        <p className="text-base font-medium text-muted-foreground mt-6">
                        ...
                        {contentFeatures.map((item) => {
                            return (
                                <Link
                                    key={item.id}
                                    to="#persionalize"
                                    className="rounded-md flex-1 border border-primary flex flex-col items-center gap-6 p-6 group cursor-pointer hover:bg-primary/90 text-primary hover:text-secondary"
                                >
                                    {item.icon}
            ...
            <section id="persionalize" className="bg-white">
                <div className="max-w-[1200px] mx-auto text-center py-28">
                    <div className="max-w-[800px] mx-auto">
                        ...
                        <h2 className="text-5xl font-bold text-primary">Enrich and personalize learning</h2>
                        <p className="text-base font-medium text-muted-foreground mt-6">
                        ...
                        <div className="flex-1">
                            ...
                            <Accordion type="single" collapsible className="w-full">
                                <AccordionItem value="item-1">
                                    ...
                                    <AccordionContent className="text-left text-muted-foreground text-base">
            ...
            <section id="persionalize" className="bg-accent">
                <div className="max-w-[1200px] mx-auto text-center py-28">
                    ...
                    <div className="grid grid-cols-3 mt-10 text-left gap-10">
                        <h1 className="col-span-3 text-left text-2xl font-semibold mb-4">
